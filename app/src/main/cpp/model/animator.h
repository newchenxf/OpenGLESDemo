...
public:
	...
	void CalculateBoneTransform(const AssimpNodeData* node, glm::mat4 parentTransform)
	{
        ...
        LOGCATE("CalculateBoneTransform, m_GlobalTransformation %s", glm::to_string(globalTransformation).c_str() );
		...
		if (boneInfoMap.find(nodeName) != boneInfoMap.end())
		{
			...
			glm::mat4 offset = boneInfoMap[nodeName].offset;//offset可能是单位矩阵
