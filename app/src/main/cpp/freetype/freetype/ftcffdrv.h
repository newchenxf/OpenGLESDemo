...
FT_BEGIN_HEADER
   ...
   *   designed for the fonts.  This makes the screen display as close as it
   ...
   *   `blue zones') as defined in the fonts are positioned independently,
   *   each being rounded to the nearest pixel edge, taking care of
   *   overshoot suppression at small sizes, stem darkening, and scaling.
   *
   *   Hstems (this is, hint values defined in the fonts to help align
