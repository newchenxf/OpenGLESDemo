...
/*    to hold fonts names, copyright info, notices, etc.) (specification).  */
/*                                                                         */
...
FT_BEGIN_HEADER
  ...
  /*    a special names table (`name') in fonts files.  This table contains */
  /*    textual (and internationalized) information regarding the fonts,    */
