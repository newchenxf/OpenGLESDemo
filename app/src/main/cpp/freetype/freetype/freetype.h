...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Abstract>                                                            */
  /*    The FreeType~2 base fonts interface.                                */
  /*                                                                       */
  /* <Description>                                                         */
  ...
  /*    are expressed in fonts units instead.                               */
  /*                                                                       */
  /* <Fields>                                                              */
  /*    width ::                                                           */
  /*      The glyph's width.                                               */
  ...
  /*    of glyphs for a given point size and resolution) in a bitmap fonts. */
  ...
  /* <Note>                                                                */
  /*    Windows FNT:                                                       */
  /*      The nominal size given in a FNT fonts is not reliable.  If the    */
  /*      driver finds it incorrect, it sets `size' to some calculated     */
  /*      values, and `x_ppem' and `y_ppem' to the pixel width and height  */
  /*      given in the fonts, respectively.                                 */
  /*                                                                       */
  /*    TrueType embedded bitmaps:                                         */
  /*      `size', `width', and `height' values are not contained in the    */
  /*      bitmap strike itself.  They are computed from the global fonts    */
  /*      parameters.                                                      */
  /*                                                                       */
  ...
  /*    fonts driver, a renderer, or anything else that provides services   */
  /*    to the former.                                                     */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A handle to a given FreeType fonts driver object.  A fonts driver    */
  /*    is a module capable of creating faces from fonts files.             */
  /*                                                                       */
  ...
  /*    into glyph indexes for its parent's face.  Some fonts formats may   */
  /*    provide several charmaps per fonts.                                 */
  /*                                                                       */
...
#define FT_ENC_TAG( value, a, b, c, d )         \
  ...
  /*      the fonts contains it), use value 0x1F028 as the input value for  */
  /*      @FT_Get_Char_Index.                                              */
  /*                                                                       */
  ...
  /*      PostScript fonts.  It is limited to 256 character codes.          */
  /*                                                                       */
  ...
  /*    fonts file, for the cases when they are needed, with the Adobe      */
  /*    values as well.                                                    */
  /*                                                                       */
  ...
  /*    the fonts is encoded in KOI8-R.                                     */
  /*                                                                       */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*    typeface in a fonts file.                                           */
  /*                                                                       */
  /* <Fields>                                                              */
  /*    num_faces           :: The number of faces in the fonts file.  Some */
  /*                           fonts formats can have multiple faces in     */
  /*                           a single fonts file.                         */
  /*                                                                       */
  /*    face_index          :: This field holds two different values.      */
  /*                           Bits 0-15 are the index of the face in the  */
  /*                           fonts file (starting with value~0).  They    */
  ...
  /*                           fonts access without a named instance).  For */
  ...
  /*                           GX or OpenType variation (sub)fonts.  Bit 31 */
  /*                           is always zero (this is, `style_flags' is   */
  /*                           always a positive value).  Note that a      */
  /*                           variation fonts has always at least one      */
  ...
  /*                           PDF file).                                  */
  /*                                                                       */
  /*                           In case the fonts doesn't provide a specific */
  ...
  /*                           `Bold', `Condensed', etc).  Not all fonts    */
  ...
  /*                                                                       */
  /*    bbox                :: The fonts bounding box.  Coordinates are     */
  /*                           expressed in fonts units (see                */
  /*                           `units_per_EM').  The box is large enough   */
  /*                           to contain any glyph from the fonts.  Thus,  */
  ...
  /*                                                                       */
  /*    units_per_EM        :: The number of fonts units per EM square for  */
  /*                           this face.  This is typically 2048 for      */
  /*                           TrueType fonts, and 1000 for Type~1 fonts.  */
  /*                           Only relevant for scalable formats.         */
  /*                                                                       */
  /*    ascender            :: The typographic ascender of the face,       */
  /*                           expressed in fonts units.  For fonts formats  */
  ...
  /*                           expressed in fonts units.  It is always      */
  ...
  /*                           `ascender - descender'.                     */
  /*                                                                       */
  /*    max_advance_width   :: The maximum advance width, in fonts units,   */
  /*                           for all glyphs in this face.  This can be   */
  /*                           used to make word wrapping computations     */
  /*                           faster.  Only relevant for scalable         */
  /*                           formats.                                    */
  /*                                                                       */
  /*    max_advance_height  :: The maximum advance height, in fonts units,  */
  ...
  /*                           scalable formats.                           */
  /*                                                                       */
  /*    underline_position  :: The position, in fonts units, of the         */
  /*                           underline line for this face.  It is the    */
  /*                           center of the underlining stem.  Only       */
  /*                           relevant for scalable formats.              */
  /*                                                                       */
  /*    underline_thickness :: The thickness, in fonts units, of the        */
  ...
  /*    @FT_Attach_Stream.                                                 */
  /*                                                                       */
  /*    For an OpenType variation fonts, the values of the following fields */
  /*    can change after a call to @FT_Set_Var_Design_Coordinates (and     */
  /*    friends) if the fonts contains an `MVAR' table: `ascender',         */
  ...
  /*                                                                       */
  /*    FT_FACE_FLAG_HINTER ::                                             */
  /*      The fonts driver has a hinting machine of its own.  For example,  */
  ...
  /*      corresponding glyphs in the subsetted fonts exist make            */
  ...
  /*                                                                       */
  /*    FT_FACE_FLAG_TRICKY ::                                             */
  /*      The face is `tricky', this is, it always needs the fonts format's */
  /*      native hinting engine to get a reasonable result.  A typical     */
  /*      example is the old Chinese fonts `mingli.ttf' (but not            */
...
#define FT_FACE_FLAG_COLOR             ( 1L << 14 )
   ...
   *   horizontal metrics (this is true for all fonts formats though).
   *
   * @also:
...
#define FT_HAS_KERNING( face ) \
   ...
   *   fonts face (true for TrueType, Type~1, Type~42, CID, OpenType/CFF,
   *   and PFR fonts formats).
   *
   */
#define FT_IS_SCALABLE( face ) \
   ...
   *
   * @description:
   *   A macro that returns true whenever a face object contains a fonts
...
#define FT_IS_SFNT( face ) \
   ...
   *
   * @description:
   *   A macro that returns true whenever a face object contains a fonts face
...
#define FT_HAS_MULTIPLE_MASTERS( face ) \
   ...
   *   of a GX or OpenType variation fonts.
   *
   */
#define FT_IS_NAMED_INSTANCE( face ) \
   ...
   *   fonts.  See the discussion of @FT_FACE_FLAG_CID_KEYED for more
   *   details.
   *
...
#define FT_IS_CID_KEYED( face ) \
   ...
   *
   * @description:
   *   A macro that returns true whenever a face represents a `tricky' fonts.
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                    horizontal metrics from fonts units to 26.6         */
  /*                    fractional pixels.  Only relevant for scalable     */
  /*                    fonts formats.                                      */
  /*                                                                       */
  /*    y_scale      :: A 16.16 fractional scaling value to convert        */
  /*                    vertical metrics from fonts units to 26.6           */
  /*                    fractional pixels.  Only relevant for scalable     */
  /*                    fonts formats.                                      */
  /*                                                                       */
  ...
  typedef struct  FT_Size_Metrics_
  {
    ...
    FT_Fixed   x_scale;     /* scaling values used to convert fonts    */
  ...
  /*    face              :: A handle to the parent face object.           */
  /*                                                                       */
  /*    next              :: In some cases (like some fonts tools), several */
  ...
  /*                         fractional pixels or fonts units.              */
  /*                                                                       */
  ...
  /*                         FreeType.                                     */
  /*                                                                       */
  /*    control_data      :: Certain fonts drivers can also return the      */
...
#define ft_open_params    FT_OPEN_PARAMS
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A structure to indicate how to open a new fonts file or stream.  A  */
  ...
  /*                   it simply specifies the fonts driver to use for      */
  ...
  /*                                                                       */
  /*    params      :: Extra parameters passed to the fonts driver when     */
  /*                   opening a new face.                                 */
  /*                                                                       */
  /* <Note>                                                                */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Call @FT_Open_Face to open a fonts by its pathname.                 */
  /*                                                                       */
  /* <InOut>                                                               */
  /*    library    :: A handle to the library resource.                    */
  /*                                                                       */
  /* <Input>                                                               */
  /*    pathname   :: A path to the fonts file.                             */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Call @FT_Open_Face to open a fonts that has been loaded into        */
  /*    memory.                                                            */
  /*                                                                       */
  /* <InOut>                                                               */
  /*    library    :: A handle to the library resource.                    */
  /*                                                                       */
  /* <Input>                                                               */
  /*    file_base  :: A pointer to the beginning of the fonts data.         */
  /*                                                                       */
  /*    file_size  :: The size of the memory chunk used by the fonts data.  */
  /*                                                                       */
  /*    face_index :: See @FT_Open_Face for a detailed description of this */
  /*                  parameter.                                           */
  /*                                                                       */
  ...
  /*                  are the index of the face in the fonts file (starting */
  /*                  with value~0).  Set it to~0 if there is only one     */
  /*                  face in the fonts file.                               */
  /*                                                                       */
  ...
  /*                  quickly check whether the fonts format of a given     */
  /*                  fonts resource is supported by FreeType.  In general, */
  /*                  if the `face_index' argument is negative, the        */
  /*                  function's return value is~0 if the fonts format is   */
  ...
  /*                  gives the number of faces within the fonts file.  For */
  ...
  /*                  have a variation fonts (or zero otherwise).  After    */
  ...
  /*    attach an AFM file that comes with a Type~1 fonts to get the        */
  ...
  /*    depends on the fonts format (and thus the fonts driver).             */
  /*                                                                       */
  ...
  /*    i.e., what input size (in fonts units) maps to the requested output */
  ...
  /*      bears no relation to the actual size of the glyphs in a fonts.    */
  /*                                                                       */
  ...
  /*      The fonts bounding box.  The width and height of the `bbox' field */
  ...
  /*      want to specify the fonts size for, say, a window of a given      */
  ...
  /*    source face.  The fonts designer chooses the final size of each     */
  ...
  /*                                                                       */
  /* <Input>                                                               */
  /*    glyph_index :: The index of the glyph in the fonts file.  For       */
  ...
  /*    don't have a corresponding glyph in the fonts).  See the discussion */
  ...
  /*    since its glyph indices are not listed in any of the fonts's        */
  /*    charmaps.                                                          */
  /*                                                                       */
  FT_EXPORT( FT_Error )
   ...
   *        the fonts file, scaled to device pixels, then `hinted' to the
   ...
   *
   *   FT_LOAD_NO_SCALE ::
   *     Don't scale the loaded outline glyph but keep it in fonts units.
   *
   *     This flag implies @FT_LOAD_NO_HINTING and @FT_LOAD_NO_BITMAP, and
   *     unsets @FT_LOAD_RENDER.
   *
   *     If the fonts is `tricky' (see @FT_FACE_FLAG_TRICKY for more), using
   *     FT_LOAD_NO_SCALE usually yields meaningless outlines because the
   *     subglyphs must be scaled and positioned with hinting instructions.
   *     This can be solved by loading the fonts without FT_LOAD_NO_SCALE and
   *     setting the character size to `fonts->units_per_EM'.
   *
   *   FT_LOAD_NO_HINTING ::
   ...
   *     various fonts formats.
   *
   *   FT_LOAD_FORCE_AUTOHINT ::
   *     Prefer the auto-hinter over the fonts's native hinter.  See also
   *     the note below.
   *
   *   FT_LOAD_PEDANTIC ::
   *     Make the fonts driver perform pedantic verifications during glyph
   ...
   *
   *   FT_LOAD_NO_RECURSE ::
   *     Don't load composite glyphs recursively.  Instead, the fonts
   ...
   *     @FT_GlyphSlotRec in fonts units.  See @FT_GlyphSlotRec for
   *     details.
   *
   *   FT_LOAD_NO_AUTOHINT ::
   ...
   *     fonts).  This flag is mainly used by fonts validating or fonts
   ...
   *
   * @note:
   *   By default, hinting is enabled and the fonts's native hinter (see
   ...
   *   fonts provides an incorrect mapping (for example, assigning the
...
#define FT_LOAD_BITMAP_METRICS_ONLY          ( 1L << 22 )
  ...
  /* used internally only by certain fonts drivers */
...
#define FT_LOAD_SBITS_ONLY                   ( 1L << 14 )
   ...
   *
   *   Note that a fonts's native hinters may ignore the hinting algorithm
   ...
   *     ClearType fonts renderer.  This preserves inter-glyph spacing in
   *     horizontal text.  The snapping is done either by the native fonts
   *     driver, if the driver itself and the fonts support it, or by the
   *     auto-hinter.
   *
...
#define FT_LOAD_TARGET_MODE( x )  ( (FT_Render_Mode)( ( (x) >> 16 ) & 15 ) )
  ...
  /*                                                                       */
  /*    The selected render mode only affects vector glyphs of a fonts.     */
...
#define ft_render_mode_mono    FT_RENDER_MODE_MONO
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    To get meaningful results, fonts scaling values must be set with    */
  ...
  /*                           26.6 fractional pixels.                     */
  /*                                                                       */
  /*    FT_KERNING_UNSCALED :: Return the kerning vector in original fonts  */
  /*                           units.                                      */
  /*                                                                       */
  /* <Note>                                                                */
...
#define ft_kerning_unscaled  FT_KERNING_UNSCALED
  ...
  /*                                                                       */
  /* <Output>                                                              */
  /*    akerning    :: The kerning vector.  This is either in fonts units,  */
  ...
  /*    supported; use @FT_HAS_KERNING to find out whether a fonts has data */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    Currently, only the Type~1 fonts driver supports track kerning,     */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    If you use FreeType to manipulate the contents of fonts files       */
...
#define FT_SUBGLYPH_FLAG_USE_MY_METRICS      0x200
  ...
  /*    in a TrueType or OpenType fonts and the `FSType' entry in a         */
  /*    PostScript fonts.  These bit flags are returned by                  */
  /*    @FT_Get_FSType_Flags; they inform client applications of embedding */
  /*    and subsetting restrictions associated with a fonts.                */
  /*                                                                       */
  /*    See                                                                */
  ...
  /*      the fonts software copyright owner.                               */
  /*                                                                       */
  /*    FT_FSTYPE_PREVIEW_AND_PRINT_EMBEDDING ::                           */
  /*      The fonts may be embedded and temporarily loaded on the remote    */
  /*      system.  Documents containing Preview & Print fonts must be      */
  /*      opened `read-only'; no edits can be applied to the document.     */
  /*                                                                       */
  /*    FT_FSTYPE_EDITABLE_EMBEDDING ::                                    */
  /*      The fonts may be embedded but must only be installed temporarily  */
  ...
  /*      The fonts may not be subsetted prior to embedding.                */
  /*                                                                       */
  /*    FT_FSTYPE_BITMAP_EMBEDDING_ONLY ::                                 */
  /*      Only bitmaps contained in the fonts may be embedded; no outline   */
  /*      data may be embedded.  If there are no bitmaps available in the  */
  /*      fonts, then the fonts is unembeddable.                             */
  /*                                                                       */
  /* <Note>                                                                */
  /*    The flags are ORed together, thus more than a single value can be  */
  /*    returned.                                                          */
  /*                                                                       */
  /*    While the `fsType' flags can indicate that a fonts may be embedded, */
  /*    a license with the fonts vendor may be separately required to use   */
  /*    the fonts in this way.                                              */
  /*                                                                       */
...
#define FT_FSTYPE_BITMAP_EMBEDDING_ONLY         0x0200
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Return the `fsType' flags for a fonts.                              */
  /*                                                                       */
  /* <Input>                                                               */
  /*    face :: A handle to the source face object.                        */
  /*                                                                       */
  ...
  /*    contains lists of all variations supported by the fonts.            */
  /*                                                                       */
  /*    A variation may be either `default' or `non-default' for a given   */
  /*    fonts.  A default variation is the one you will get for that code   */
  ...
  /*      a) the fonts has a variation selector cmap sub table,             */
  /*    and                                                                */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    This function is only meaningful if the fonts has a variation       */
