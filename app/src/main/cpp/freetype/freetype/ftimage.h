...
FT_BEGIN_HEADER
  ...
  /*    on the context, these can represent distances in integer fonts      */
  ...
  /*      anti-aliased bitmaps in fonts files according to the OpenType     */
  /*      specification.  We haven't found a single fonts using this        */
  /*      format, however.                                                 */
  /*                                                                       */
  /*    FT_PIXEL_MODE_GRAY4 ::                                             */
  /*      A 4-bit per pixel bitmap, representing embedded anti-aliased     */
  /*      bitmaps in fonts files according to the OpenType specification.   */
  /*      We haven't found a single fonts using this format, however.       */
  /*                                                                       */
  /*    FT_PIXEL_MODE_LCD ::                                               */
...
#define FT_IMAGE_TAG( value, _x1, _x2, _x3, _x4 )  \
  ...
  /*    formats, even though future fonts drivers will be able to register  */
  /*    their own format.                                                  */
  /*                                                                       */
  /* <Values>                                                              */
