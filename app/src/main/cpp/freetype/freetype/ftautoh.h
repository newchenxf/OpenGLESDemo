...
FT_BEGIN_HEADER
   ...
   *   auto-hinted, the Unicode character map of the fonts gets examined, and
   ...
   *   array with `num_glyphs' elements, as found in the fonts's @FT_Face
   *   structure.  The `glyph-to-script-map' property returns a pointer to
   *   this array, which can be modified as needed.  Note that the
   *   modification should happen before the first glyph gets processed by
   *   the auto-hinter so that the global analysis of the fonts shapes
...
#define FT_AUTOHINTER_SCRIPT_INDIC  3
   ...
   *   used for the default (OpenType) script data of a fonts's GSUB table.
   ...
   *   up the fonts's x~height much more often than normally.  If the value
   *   is set to~0, which is the default, this feature is switched off.  Use
   *   this property to improve the legibility of small fonts sizes if
   *   necessary.
   *
   *   {
   *     FT_Library               library;
   ...
   *   that glyphs `thin out'.  Mac OS~X and Adobe's proprietary fonts
   ...
   *
   *   This is a passive setting that only takes effect if the fonts driver
