...
FT_BEGIN_HEADER
  ...
  /*   Only for fonts debugging.  Checks that a table follows the           */
  /*   specification by 100%.  Very few fonts will be able to pass this    */
  /*   level anyway but it can be useful for certain tools like fonts       */
  /*   editors/converters.                                                 */
  /*                                                                       */
...
#define FT_VALIDATOR( x )  ( (FT_Validator)( x ) )
  ...
  /* if you run it on an invalid fonts.                                   */
  FT_BASE( FT_Int )
