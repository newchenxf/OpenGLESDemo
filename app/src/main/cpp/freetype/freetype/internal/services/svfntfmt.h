...
/*  svfntfmt.h                                                             */
/*                                                                         */
/*    The FreeType fonts format service (specification only).               */
/*                                                                         */
...
FT_BEGIN_HEADER
  ...
  /*
   *  A trivial service used to return the name of a face's fonts driver,
   *  according to the XFree86 nomenclature.  Note that the service data
   *  is a simple constant string pointer.
   */

#define FT_SERVICE_ID_FONT_FORMAT  "fonts-format"
