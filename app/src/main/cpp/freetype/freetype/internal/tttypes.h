...
FT_BEGIN_HEADER
  ...
  /*    the fonts headers of each distinct TrueType face in the file.       */
  /*                                                                       */
  /* <Fields>                                                              */
  ...
  /*               specific purposes.                                      */
  /*                                                                       */
  /*    offsets :: The offsets of the fonts headers, one per face.          */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*    format_tag     :: The fonts format tag.                             */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    This structure describes a given table of a TrueType fonts.         */
  /*                                                                       */
  /* <Fields>                                                              */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    This structure describes a given table of a WOFF fonts.             */
  /*                                                                       */
  /* <Fields>                                                              */
  /*    Tag        :: A four-bytes tag describing the table.               */
  /*                                                                       */
  ...
  /*    TrueType tables.  The values are expressed in fonts units.          */
  /*                                                                       */
  /* <Fields>                                                              */
...
#define TT_GASP_DOGRAY   0x02
  ...
  /*    in a TrueType or OpenType fonts.  These are usually found in the    */
  ...
  /* shared between fonts drivers, and are thus defined in `ttobjs.h'.      */
  /*                                                                       */
  /*************************************************************************/
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A handle to a TrueType face/fonts object.  A TT_Face encapsulates   */
  /*    the resolution and scaling independent parts of a TrueType fonts    */
  /*    resource.                                                          */
  /*                                                                       */
  /* <Note>                                                                */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    The stream cursor must be at the fonts file's origin.               */
  /*                                                                       */
  typedef FT_Error
  ...
  /* OpenType 1.8 brings new tables for variation fonts support;  */
  ...
  /*                                                             */
  /* Note that `fvar' gets checked immediately at fonts loading,  */
...
#define TT_FACE_FLAG_VAR_MVAR  ( 1 << 8 )
  ...
  /*    point-size independent data found in a TrueType fonts file.         */
  /*                                                                       */
  /* <Fields>                                                              */
  ...
  /*                            For ordinary fonts files, the field         */
  /*                            `ttc_header.count' is set to 0.            */
  /*                                                                       */
  /*    format_tag           :: The fonts format tag.                       */
  /*                                                                       */
  /*    num_tables           :: The number of TrueType tables in this fonts */
  /*                            file.                                      */
  /*                                                                       */
  /*    dir_tables           :: The directory of TrueType tables for this  */
  /*                            fonts file.                                 */
  /*                                                                       */
  /*    header               :: The fonts's fonts header (`head' table).     */
  /*                            Read on fonts opening.                      */
  /*                                                                       */
  /*    horizontal           :: The fonts's horizontal header (`hhea'       */
  /*                            table).  This field also contains the      */
  /*                            associated horizontal metrics table        */
  /*                            (`hmtx').                                  */
  /*                                                                       */
  /*    max_profile          :: The fonts's maximum profile table.  Read on */
  /*                            fonts opening.  Note that some maximum      */
  /*                            values cannot be taken directly from this  */
  /*                            table.  We thus define additional fields   */
  /*                            below to hold the computed maxima.         */
  /*                                                                       */
  /*    vertical_info        :: A boolean which is set when the fonts file  */
  /*                            contains vertical metrics.  If not, the    */
  /*                            value of the `vertical' field is           */
  /*                            undefined.                                 */
  /*                                                                       */
  /*    vertical             :: The fonts's vertical header (`vhea' table). */
  ...
  /*                                                                       */
  /*    os2                  :: The fonts's OS/2 table (`OS/2').            */
  /*                                                                       */
  /*    postscript           :: The fonts's PostScript table (`post'        */
  ...
  /*                            given glyph within the face's fonts file.   */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    num_sbit_scales      :: The number of sbit scales for this fonts.   */
  /*                                                                       */
  /*    sbit_scales          :: Array of sbit scales embedded in this      */
  /*                            fonts.  This table is optional in a         */
  /*                            TrueType/OpenType fonts.                    */
  /*                                                                       */
  /*    postscript_names     :: A table used to store the Postscript names */
  /*                            of  the glyphs for this fonts.  See the     */
  /*                            file  `ttconfig.h' for comments on the     */
  /*                            TT_CONFIG_OPTION_POSTSCRIPT_NAMES option.  */
  /*                                                                       */
  /*    font_program_size    :: Size in bytecodes of the face's fonts       */
  /*                            program.  0 if none defined.  Ignored for  */
  /*                            Type 2 fonts.                              */
  /*                                                                       */
  /*    font_program         :: The face's fonts program (bytecode stream)  */
  /*                            executed at load time, also used during    */
  /*                            glyph rendering.  Comes from the `fpgm'    */
  /*                            table.  Ignored for Type 2 fonts fonts.     */
  /*                                                                       */
  ...
  /*                            Coordinates are expressed in unscaled fonts */
  ...
  /*                                                                       */
  /*    extra                :: Reserved for third-party fonts drivers.     */
  /*                                                                       */
  /*    postscript_name      :: The PS name of the fonts.  Used by the      */
  ...
  /*                                                                       */
  /*    is_cff2              :: Set if the fonts format is CFF2.            */
  /*                                                                       */
  /*    doblend              :: A boolean which is set if the fonts should  */
  ...
  /*                            functionality related to fonts variation    */
  ...
  /*                            constructing a variation fonts instance's   */
  /*                            PS name .                                  */
  /*                                                                       */
  ...
  /*                            Ignored for Type 2 fonts faces.             */
  /*                                                                       */
  ...
  /*                            in the `hdmx' table.                       */
  /*                                                                       */
  /*    sbit_table           :: A pointer to the fonts's embedded bitmap    */
  /*                            location table.                            */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    bdf                  :: Data related to an SFNT fonts's `bdf'       */
  /*                            table; see `tttypes.h'.                    */
  /*                                                                       */
  ...
  /*                                                                       */
  /*     org          :: The original glyph coordinates (fonts              */
  /*                     units/scaled).                                    */
  /*                                                                       */
