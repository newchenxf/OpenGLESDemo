...
#define FT_PIX_CEIL_INT32( x )      FT_PIX_FLOOR( ADD_INT32( (x), 63 ) )
   ...
   *  fonts files, we must not use those in <ctypes.h> which are
   *  locale-dependent
   */
...
#define FT_DEFINE_CMAP_CLASS(                            \
  ...
  /*      outlines after they are loaded from the fonts.  Only used by the  */
  /*      convenience functions.                                           */
  /*                                                                       */
  /*    transform_delta ::                                                 */
  /*      A translation vector used to transform glyph outlines after they */
  /*      are loaded from the fonts.  Only used by the convenience          */
  /*      functions.                                                       */
  /*                                                                       */
  /*    transform_flags ::                                                 */
  ...
  /*      operator.  Value~0 means to use the fonts's value.  Value~-1      */
  ...
  /*                         fonts transformation.  This is _not_ the same  */
...
#define FT_DRIVER_CLASS( x )  FT_DRIVER( x )->clazz
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    The root fonts driver class.  A fonts driver is responsible for      */
  /*    managing and loading fonts files of a given format.                 */
  /*                                                                       */
  /*  <Fields>                                                             */
  /*     root         :: Contains the fields of the root module class.     */
  /*                                                                       */
  /*     clazz        :: A pointer to the fonts driver's class.  Note that  */
...
#define FT_DEBUG_HOOK_TRUETYPE  0
  ...
  /*                        registered modules. Note that each fonts driver */
  ...
  /*                        debuggers to hook into a fonts format's         */
