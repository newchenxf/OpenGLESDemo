...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /*    face_index :: The index of the TrueType fonts, if we are opening a  */
  /*                  collection, in bits 0-15.  The numbered instance     */
  /*                  index~+~1 of a GX (sub)fonts, if applicable, in bits  */
  /*                  16-30.                                               */
  /*                                                                       */
  ...
  /*    collection'.                                                       */
  /*                                                                       */
  /*    Once the format tag has been validated by the fonts driver, it      */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Load any fonts table into client memory.                            */
  /*                                                                       */
  /* <Input>                                                               */
  /*    face   :: The face object to look for.                             */
  /*                                                                       */
  /*    tag    :: The tag of table to load.  Use the value 0 if you want   */
  /*              to access the whole fonts file, else set this parameter   */
  ...
  /*                  table or of the fonts file, depending on the value of */
  /*                  `tag'.                                               */
  /*                                                                       */
  /*                If *length != 0:                                       */
  /*                  Loads the next `length' bytes of table or fonts,      */
  /*                  starting at offset `offset' (in table or fonts too).  */
  /*                                                                       */
  /* <Output>                                                              */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Load a given glyph sbit image from the fonts resource.  This also   */
  /*    returns its metrics.                                               */
  /*                                                                       */
  /* <Input>                                                               */
  /*    face ::                                                            */
  ...
  /*    start of the table, except while loading the fonts directory.       */
  /*                                                                       */
  typedef FT_Error
   ...
   *
   * @return:
   *    The kerning value in fonts units.
   */
  typedef FT_Int
  ...
  /*    free the basic tables that are required in a `sfnt' fonts file.     */
  /*                                                                       */
  /* <Fields>                                                              */
  ...
  typedef struct  SFNT_Interface_
  {
    ...
    /* load the fonts directory, i.e., the offset table and */
    /* the table directory                                 */
