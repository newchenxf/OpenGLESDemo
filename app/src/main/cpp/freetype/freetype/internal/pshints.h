...
/*    T1/T2 hints in the `type1', `cid', and `cff' fonts drivers.           */
/*                                                                         */
...
FT_BEGIN_HEADER
   ...
   *
   *   globals ::
   *     The hinter globals for this fonts.
   *
   *   hint_mode ::
   *     Hinting information.
   *
   ...
   *
   * @note:
   *   On input, all points within the outline are in fonts coordinates. On
   *   output, they are in 1/64th of pixels.
   *
   *   The scaling transformation is taken from the `globals' object which
   *   must correspond to the same fonts as the glyph.
   *
   */
  typedef FT_Error
   ...
   *   element is an absolute position in fonts units, each odd element is a
   *   length in fonts units.
   *
   ...
   *
   *   The scaling transformation is taken from the `globals' object which
   *   must correspond to the same fonts than the glyph.
   *
   */
  typedef FT_Error
