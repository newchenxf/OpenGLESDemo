...
/*  ftmm.h                                                                 */
/*                                                                         */
/*    FreeType Multiple Master fonts interface (specification).             */
/*                                                                         */
...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /*    strid   :: The axis name entry in the fonts's `name' table.  This   */
  ...
  /*    GX, or OpenType variation fonts.                                    */
  /*                                                                       */
  ...
  /*                       The fonts can tell the user that, for example,   */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Retrieve a variation descriptor of a given Adobe MM fonts.          */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Retrieve a variation descriptor for a given fonts.                  */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    For Adobe MM fonts, choose an interpolated fonts design through     */
  /*    design coordinates.                                                */
  /*                                                                       */
  /*    This function can't be used with TrueType GX or OpenType variation */
  /*    fonts.                                                             */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Choose an interpolated fonts design through design coordinates.     */
  /*                                                                       */
  /*    This function works with all supported variation formats.          */
  /*                                                                       */
  /* <InOut>                                                               */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Choose an interpolated fonts design through normalized blend        */
  /*    coordinates.                                                       */
  /*                                                                       */
  /*    This function works with all supported variation formats.          */
  /*                                                                       */
